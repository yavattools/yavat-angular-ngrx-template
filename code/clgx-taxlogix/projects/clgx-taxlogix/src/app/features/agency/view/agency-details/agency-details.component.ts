...
export class AgencyDetailsComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    if(this.agency$){
      this.agencyDetails = this.fb.group({
        ...
        agencySuitsAddress: [this.agency.agencySuitsAddress, Validators.required],
        ...
        assessorContactName: [this.agency.assessorContactName, Validators.required],
        assessorPhoneNumber: [this.agency.assessorPhoneNumber, Validators.required],
  ...
  save(form: FormGroup) {
    this.newAgencyDetails = new Agency();
    ...
    this.newAgencyDetails.agencyLowerLevel = form.controls['agencyLowerLevel'].value;
    this.newAgencyDetails.agencyCollecting = form.controls['agencyCollecting'].value;
    this.newAgencyDetails.agencyActive = form.controls['agencyActive'].value;
    this.newAgencyDetails.agencySuitsAddress = form.controls['agencySuitsAddress'].value;
