...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<clgx-big-input-action></clgx-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<clgx-big-input-action [disabled]="true"></clgx-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template =
      '<clgx-big-input-action fontSet="fas" fontIcon="trash"></clgx-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template =
      '<clgx-big-input-action label="delete"></clgx-big-input-action>';
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template =
      '<clgx-big-input-action (action)="actionHandler()"></clgx-big-input-action>';
    fixture = createHostComponent(template);
